      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Fill in the details to add a new influencer to the database.
          </p>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="name" name="name" required placeholder="Full name" value={form.name} onChange={handleInputChange} />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="phone" name="phone" placeholder="+91..." value={form.phone} onChange={handleInputChange} />
            ...
            <div className="space-y-2">
              ...
              <Input id="dateOfBirth" name="dateOfBirth" type="date" value={form.dateOfBirth} onChange={handleInputChange} />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2 sm:col-span-2">
              ...
              <Textarea id="bio" name="bio" placeholder="Short bio..." value={form.bio} onChange={handleInputChange} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="pincode" name="pincode" placeholder="Pincode" value={form.pincode} onChange={handleInputChange} />
              {errors.pincode && <p className="text-xs text-red-500 mt-1">{errors.pincode}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="city">City</Label>
              <Input id="city" name="city" placeholder="City" value={form.city} onChange={handleInputChange} />
            </div>
            <div className="space-y-2">
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-2 sm:col-span-2 lg:col-span-3">
              ...
              <Textarea
                id="rateNotes"
                name="rateNotes"
                placeholder="Any notes about rates..."
